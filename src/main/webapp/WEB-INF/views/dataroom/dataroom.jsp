...
<c:forEach var="f" items="${files }">
	<input type="hidden" name="jd_no" value="${f.jd_no }">
	<input type="hidden" name="jd_id" value="${f.jd_id }">
	<input type="hidden" name="jd_title" value="${f.jd_title }">
	<input type="hidden" name="jm_name" value="${f.jm_name }">
	<input type="hidden" name="jm_photo" value="${f.jm_photo }">
